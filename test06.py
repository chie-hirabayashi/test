...
excel_db_map = {
    "WEBサイト": {
        ...
        "column": {
            ...
            "div_name1": {"type": "text", "index": 2},
            "div_name2": {"type": "text", "index": 3},
        },
    },
    "人口": {
        "min_row": 2,
...
def db_insert(book, db_map):
    ...
    dbname = os.path.join(current_dir, "saitama6.db")
...
wb = excel.load_workbook(
    "/Users/admin/camp/create/saitama_city6.xlsx", data_only=True
)
